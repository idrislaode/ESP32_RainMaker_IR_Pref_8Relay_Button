/**********************************************************************************
 *  TITLE: ESP RainMaker + IR + Manual Button control 8 Relays using ESP32 (store last GPIO state + Real time feedback + no WiFi control)
...
const char *service_name = "BLE KKRBT HOME";
...
char nodeName[] = "Kakarobot Smart-Home";

// define the Device Names
char deviceName_1[] = "Lampu Depan";
char deviceName_2[] = "Lampu Ruang Tengah";
char deviceName_3[] = "Lampu Kamar 1";
char deviceName_4[] = "Lampu Kamar 2";
char deviceName_5[] = "Lampu Kamar 3";
char deviceName_6[] = "Lampu Dapur";
char deviceName_7[] = "Lampu WC";
char deviceName_8[] = "TV Tengah";
